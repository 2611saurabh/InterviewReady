...
import org.spring.lldPractice.tomato.factories.NowOrderFactory;
import org.spring.lldPractice.tomato.factories.OrderFactory;
import org.spring.lldPractice.tomato.factories.ScheduledOrderFactory;
import org.spring.lldPractice.tomato.manager.OrderManager;
import org.spring.lldPractice.tomato.manager.RestaurantManager;
import org.spring.lldPractice.tomato.modal.*;
import org.spring.lldPractice.tomato.services.NotificationService;
...
public class TomatoApp {
    ...
    public List<Resturant> searchRestaurants(String location) {
        return RestaurantManager.getInstance().searchByLocation(location);
    }

    public void selectRestaurant(User user, Resturant restaurant) {
        Cart cart = user.getCart();
        cart.setRestaurant(restaurant);
    }

    public void addToCart(User user, String itemCode) {
        Resturant restaurant = user.getCart().getRestaurant();
        if (restaurant == null) {
    ...
    public Order checkout(User user, String orderType, PaymentStrategy paymentStrategy, OrderFactory orderFactory) {
        ...
        Resturant orderedRestaurant = userCart.getRestaurant();
